package ru.example.recipecomposeapp.data.repository
...
private val burgerRecipes = listOf(
    RecipeDto(
        ...
        listOf("1. В глубокой миске смешайте говяжий фарш, лук, чеснок, соль и перец. Разделите фарш на 4 равные части и сформируйте котлеты.",
